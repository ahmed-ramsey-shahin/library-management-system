...
using Lms.Application.Features.Books.Queries.GetBooksByAuthor;
...
namespace Lms.Api.Controllers
{
    ...
    public class BooksController(ISender sender) : ApiController
    {
        ...
        [HttpGet("/api/v{version:apiVersion}/categories/{categoryId:guid}/books")]
        [ProducesResponseType(typeof(PaginatedList<BookDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [MapToApiVersion("1.0")]
        [EndpointName("GetBooksByCategory")]
        public async Task<IActionResult> GetBooksByCategory(Guid categoryId, [FromQuery] int pageNumber, [FromQuery] int pageSize, CancellationToken cancellationToken)
        {
            var result = await sender.Send(new GetBooksByCategoryQuery(categoryId, pageSize, pageNumber), cancellationToken);
            return result.Match(Ok, Problem);
        }

        [HttpGet("/api/v{version:apiVersion}/keywords/{keywordId:guid}/books")]
        [ProducesResponseType(typeof(PaginatedList<BookDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [MapToApiVersion("1.0")]
        [EndpointName("GetBooksByKeyword")]
        public async Task<IActionResult> GetBooksByKeyword(Guid keywordId, [FromQuery] int pageNumber, [FromQuery] int pageSize, CancellationToken cancellationToken)
        {
            var result = await sender.Send(new GetBooksByKeywordQuery(keywordId, pageSize, pageNumber), cancellationToken);
            return result.Match(Ok, Problem);
        }

        [HttpGet("/api/v{version:apiVersion}/themes/{themeId:guid}/books")]
        [ProducesResponseType(typeof(PaginatedList<BookDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [MapToApiVersion("1.0")]
        [EndpointName("GetBooksByTheme")]
        ...
        [HttpGet("/api/v{version:apiVersion}/authors/{authorId:guid}/books")]
        [ProducesResponseType(typeof(PaginatedList<BookDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [MapToApiVersion("1.0")]
        [EndpointName("GetBooksByAuthor")]
        public async Task<IActionResult> GetBooksByAuthor(Guid authorId, [FromQuery] int pageNumber, [FromQuery] int pageSize, CancellationToken cancellationToken)
        {
            var result = await sender.Send(new GetBooksByAuthorQuery(authorId, pageSize, pageNumber), cancellationToken);
            return result.Match(Ok, Problem);
        }
    }
}
